...
class LidarTest(Node):
    ...
    def listener_callback(self, scan):
        ...
        index_0_deg = int((0 - angle_min_deg) / angle_increment_deg) - 1
        index_neg90_deg = int((-90 - angle_min_deg) / angle_increment_deg) - 1
        index_pos90_deg = int((90 - angle_min_deg) / angle_increment_deg) - 1
